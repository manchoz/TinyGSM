...
#elif defined(TINY_GSM_MODEM_BG96_TLS)
#include "TinyGsmClientSecureBG96.h"
typedef TinyGsmBG96TLS                TinyGsm;
typedef TinyGsmBG96TLS::GsmClientSecureBG96 TinyGsmClientSecure;
